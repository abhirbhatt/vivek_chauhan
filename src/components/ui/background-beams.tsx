                    ...
                    <defs>
                        {paths.map((path, index) => (
                            <motion.linearGradient
                                ...
                                transition={{
                                    duration: Math.random() * 20 + 20, // Slower movement (20-40 seconds)
                                    ease: "easeInOut",
                                    repeat: Infinity,
                            ...
                            >
                                ...
                                <stop offset="5%" stopColor="#18CCFC" stopOpacity="1"></stop>
                                <stop offset="12%" stopColor="#6344F5" stopOpacity="1"></stop>
                                <stop offset="18%" stopColor="#AE48FF" stopOpacity="0"></stop>
                            </motion.linearGradient>
                        ))}
